---
title: "Sedimentation rates - DataPrep"
...
sedenv_prob <- extend(rast(list.files(path = "N:/Prosjekter/311700_MAREANO/311778_Automatisert_kartlegging/Sedimentasjon/R/SedEnv/output", pattern='SedEnv3_probabilities2023-07-01', full.names = TRUE)), predictors)

sedenv_maxprob <- extend(rast("N:/Prosjekter/311700_MAREANO/311778_Automatisert_kartlegging/Sedimentasjon/R/SedEnv/output/SedEnv3_max_probabilities2023-07-01.tif"), predictors)
